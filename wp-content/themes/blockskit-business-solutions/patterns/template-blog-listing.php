 ...
 * Slug: blockskit-business-solutions/template-blog-listing
 * Categories: template
 * Inserter: false
 */
...
<div class="wp-block-column" style="flex-basis:33.33%"><!-- wp:template-part {"slug":"sidebar","theme":"blockskit-business-solutions"} /--></div>
<!-- /wp:column --></div>
<!-- /wp:columns -->